package ru.yoomoney.tech.dbqueue.dao.utils;
...
import ru.yoomoney.tech.dbqueue.dao.spring.SpringJdbcOperationsSubset;
...
public class PostgresDatabaseInitializer {
    ...
    private static JdbcOperationsSubset pgJdbcOperationsSubset;
    ...
    public static synchronized void initialize() {
        ...
        pgJdbcOperationsSubset = new SpringJdbcOperationsSubset(new NamedParameterJdbcTemplate(pgJdbcTemplate));
    ...
    public static JdbcOperationsSubset getJdbcOperationsSubset() {
        initialize();
        return pgJdbcOperationsSubset;
    }
