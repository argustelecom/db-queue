...
import ru.yoomoney.tech.dbqueue.dao.utils.OracleDatabaseInitializer;
...
public class DefaultOracle11QueuePickTaskDaoTest extends QueuePickTaskDaoTest {
    ...
    public DefaultOracle11QueuePickTaskDaoTest() {
        super(new Oracle11QueueDao(OracleDatabaseInitializer.getJdbcOperationsSubset(), OracleDatabaseInitializer.DEFAULT_SCHEMA),
                (queueLocation, failureSettings) -> new Oracle11QueuePickTaskDao(OracleDatabaseInitializer.getJdbcOperationsSubset(),
