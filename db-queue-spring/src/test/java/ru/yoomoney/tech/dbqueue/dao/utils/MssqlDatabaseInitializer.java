...
public class MssqlDatabaseInitializer {
    ...
    private static JdbcOperationsSubset msJdbcOperationsSubset;
    ...
    public static synchronized void initialize() {
        ...
        msJdbcOperationsSubset = new SpringJdbcOperationsSubset(new NamedParameterJdbcTemplate(msJdbcTemplate));
