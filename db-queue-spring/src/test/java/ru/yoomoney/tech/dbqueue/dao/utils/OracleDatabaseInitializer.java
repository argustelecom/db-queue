...
public class OracleDatabaseInitializer {
    ...
    private static JdbcOperationsSubset oraJdbcOperationsSubset;
    ...
    public static synchronized void initialize() {
        ...
        oraJdbcOperationsSubset = new SpringJdbcOperationsSubset(new NamedParameterJdbcTemplate(oraJdbcTemplate));
    ...
    public static JdbcOperationsSubset getJdbcOperationsSubset() {
        initialize();
        return oraJdbcOperationsSubset;
    }
