...
public class Oracle11QueuePickTaskDao implements QueuePickTaskDao {
    ...
    public Oracle11QueuePickTaskDao(@Nonnull JdbcOperationsSubset jdbcTemplate,
    ...
    private static class PickTaskCallableStatement implements JdbcOperationsSubset.CallableStatementCallback<TaskRecord> {
        ...
        @Override
        public TaskRecord doInCallableStatement(CallableStatement cs) throws SQLException {
            int inputIndex = 1;
