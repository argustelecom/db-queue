...
public class DefaultMssqlQueuePickTaskDaoTest extends QueuePickTaskDaoTest {
    ...
    public DefaultMssqlQueuePickTaskDaoTest() {
        super(new MssqlQueueDao(MssqlDatabaseInitializer.getJdbcOperationsSubset(), MssqlDatabaseInitializer.DEFAULT_SCHEMA),
                (queueLocation, failureSettings) -> new MssqlQueuePickTaskDao(MssqlDatabaseInitializer.getJdbcOperationsSubset(),
